...
CREATE EXTERNAL TABLE `exception_analysis`(
  `event_name` string, 
  `procedurestarttime` bigint, 
  `imsi` string, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/lte_mro_source';

DROP TABLE IF EXISTS mr_gt_cell_ana_base60;    
CREATE EXTERNAL TABLE `mr_gt_cell_ana_base60`(
  `cellid` int, 
  `ttime` string, 
  `dir_state` int, 
  `avgrsrpx` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/mr_gt_cell_ana_base60';

DROP TABLE IF EXISTS mr_gt_cell_ana_baseday;  
CREATE EXTERNAL TABLE `mr_gt_cell_ana_baseday`(
  `cellid` int, 
  `ttime` string, 
  `dir_state` int, 
  `avgrsrpx` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/mr_gt_cell_ana_baseday';

DROP TABLE IF EXISTS mr_gt_user_ana_base60;    
CREATE EXTERNAL TABLE `mr_gt_user_ana_base60`(
  `imsi` string, 
  `imei` string, 
  `msisdn` string, 
  `cellid` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/mr_gt_user_ana_base60';
 
DROP TABLE IF EXISTS mr_gt_user_ana_baseday;     
CREATE EXTERNAL TABLE `mr_gt_user_ana_baseday`(
  `imsi` string, 
  `imei` string, 
  `msisdn` string, 
  `cellid` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/mr_gt_user_ana_baseday';)

DROP TABLE IF EXISTS volte_gt_cell_ana_base60; 
CREATE EXTERNAL TABLE `volte_gt_cell_ana_base60`(
  `ttime` string, 
  `cellid` int, 
  `voltemcsucc` int, 
  `voltemcatt` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/volte_gt_cell_ana_base60';

DROP TABLE IF EXISTS volte_gt_cell_ana_baseday;   
CREATE EXTERNAL TABLE `volte_gt_cell_ana_baseday`(
  `ttime` string, 
  `cellid` int, 
  `voltemcsucc` int, 
  `voltemcatt` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/volte_gt_cell_ana_baseday';

DROP TABLE IF EXISTS volte_gt_user_ana_base60;   
CREATE EXTERNAL TABLE `volte_gt_user_ana_base60`(
  `imsi` string, 
  `imei` string, 
  `msisdn` string, 
  `cellid` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/volte_gt_user_ana_base60';
  
DROP TABLE IF EXISTS volte_gt_user_ana_baseday;    
CREATE EXTERNAL TABLE `volte_gt_user_ana_baseday`(
  `imsi` string, 
  `imei` string, 
  `msisdn` string, 
  `cellid` int, 
...
OUTPUTFORMAT 
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  '/${DCL_PATH}/volte_gt_user_ana_baseday';  

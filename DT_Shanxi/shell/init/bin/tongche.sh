...
hadoop jar ${jar_file} cn.com.dtmobile.hadoop.biz.train.job.trainsame.TrainSameU1_1Job $UU_new输出路径 $u1_output $range $imsirange $step
...
hadoop jar ${jar_file} cn.com.dtmobile.hadoop.biz.train.job.trainsame.TrainSameU4_1Job 24小时u3数据 $u4_1_output
hadoop jar ${jar_file} cn.com.dtmobile.hadoop.biz.train.job.trainsame.TrainSameU4_2Job $u3_2_output 24小时u3数据 $u4_1_output $u4_2_output

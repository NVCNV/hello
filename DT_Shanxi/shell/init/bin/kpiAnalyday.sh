...
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_user_ana_baseday/${ANALY_DATE} volte_gt_user_ana_baseday 14 2 >>  /dt/bin/sqoop_log/gt_user_day_${ANALY_DATE}/${ANALY_HOUR}_logs.log 2>&1
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_cell_ana_baseday volte_gt_cell_ana_baseday 12 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_cell_ana_baseday/${ANALY_DATE} volte_gt_cell_ana_baseday 12 2 >> /dt/bin/sqoop_log/cell_ana_day_${ANALY_DATE}/${ANALY_HOUR}_logs.log 2>&1
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_user_ana_baseday mr_gt_user_ana_baseday 18 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_user_ana_baseday/${ANALY_DATE} mr_gt_user_ana_baseday 18 2 >> /dt/bin/sqoop_log/mr_gt_user_${ANALY_DATE}/${ANALY_HOUR}_logs.log 2>&1

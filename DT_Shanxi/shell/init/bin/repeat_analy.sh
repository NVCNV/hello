...
./hdfs2db.sh hdfs://dtcluster/datang2/cellMR/${ANALY_DATE}_${ANALY_HOUR} VOLTE_CELLMR_DATA 32 2 >> /dt/bin/sqoop_log/volte_cellmr_${ANALY_DATE}_${ANALY_HOUR}_logs.log 2>&1

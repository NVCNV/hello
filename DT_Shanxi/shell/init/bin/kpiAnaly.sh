...
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/volte_gt_user_ana_base60 volte_gt_user_ana_base60 13 2"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/volte_gt_user_ana_base60/${ANALY_DATE}/${ANALY_HOUR} volte_gt_user_ana_base60 13 2
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/volte_gt_cell_ana_base60 volte_gt_cell_ana_base6 11 2"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/volte_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} volte_gt_cell_ana_base60 11 2
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_user_ana_base60 mr_gt_user_ana_base60 17 2"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_user_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_user_ana_base60 17 2
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_cell_ana_base60 mr_gt_cell_ana_base60 15 2"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_cell_ana_base60 15 2
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_cell_ana_base60 mr_gt_cell_ana_base60 33 2"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}.db/mr_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_cell_ana_base60 33 2

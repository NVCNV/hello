...
sum(kpi016),sum(kpi027),sum(kpi028),sum( kpi071),sum(kpi072),sum(kpi079),sum(kpi075),sum(kpi077),
sum(kpi083),sum(kpi084),sum(kpi086),sum(kpi087),sum(kpi090),sum(kpi091),sum(kpi036),sum(kpi092),
sum(kpi093),sum(kpi094),sum(kpi095),sum(kpi096),sum(kpi097),sum(kpi098),sum(kpi099)

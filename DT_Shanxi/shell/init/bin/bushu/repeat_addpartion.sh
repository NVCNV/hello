...
location "/datang2/output/xdrnew/ltemrosource/${ANALY_DATE}/${ANALY_HOUR}";

alter table ddl_for_kpi.lte_mro_source drop partition(dt="$ANALY_DATE",h="$ANALY_HOUR");
alter table ddl_for_kpi.lte_mro_source add partition(dt="$ANALY_DATE",h="$ANALY_HOUR") 
location "/datang2/LTE_MRO_SOURCE/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/uu/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/x2/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/sv_xdr/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/sgs/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/s1mme/${ANALY_DATE}/${ANALY_HOUR}";
...
location "/datang2/output/xdrnew/gxrx/${ANALY_DATE}/${ANALY_HOUR}";
...
hdfs dfs -cp /datang2/output/xdrnew/mw/${ANALY_DATE}/${ANALY_HOUR}/tb* /user/hive/warehouse/${DB}.db/tb_xdr_ifc_gmmwmgmimjisc_new/dt=${ANALY_DATE}/h=${ANALY_HOUR}/

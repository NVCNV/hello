...
exit 0
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_user_ana_base60 volte_gt_user_ana_base60 13 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_user_ana_base60/${ANALY_DATE}/${ANALY_HOUR} volte_gt_user_ana_base60 13 4
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_cell_ana_base60 volte_gt_cell_ana_base6 11 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/volte_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} volte_gt_cell_ana_base60 11 4
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_user_ana_base60 mr_gt_user_ana_base60 17 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_user_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_user_ana_base60 17 4
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_cell_ana_base60 mr_gt_cell_ana_base60 15 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_cell_ana_base60 15 4
echo "./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_cell_ana_base60 mr_gt_cell_ana_base60 33 4"
./hdfs2db.sh hdfs://dtcluster/user/hive/warehouse/${DB}/mr_gt_cell_ana_base60/${ANALY_DATE}/${ANALY_HOUR} mr_gt_cell_ana_base60 33 4
